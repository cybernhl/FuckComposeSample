...
object FaIcons {
    ...
    val AcquisitionsIncorporated = BrandIcon(0xf6af)

    // https://fontawesome.com/icons/ad?style=solid
    // Solid icon : Ad
    val Ad = SolidIcon(0xf641)
    ...
    val AirFreshener = SolidIcon(0xf5d0)
    ...
    val Allergies = SolidIcon(0xf461)
    ...
    // Solid icon : Angry
    val Angry = SolidIcon(0xf556)

    // https://fontawesome.com/icons/angry?style=regular
    // Regular icon : Angry
    val AngryRegular = RegularIcon(0xf556)
    ...
    val AssistiveListeningSystems = SolidIcon(0xf2a2)

    // https://fontawesome.com/icons/asterisk?style=solid
    // Solid icon : Asterisk
    val Asterisk = SolidIcon(0xf069)
    ...
    // Solid icon : At
    val At = SolidIcon(0xf1fa)

    // https://fontawesome.com/icons/atlas?style=solid
    // Solid icon : Atlas
    val Atlas = SolidIcon(0xf558)
    ...
    val Backspace = SolidIcon(0xf55a)
    ...
    val BehanceSquare = BrandIcon(0xf1b5)
    ...
    val BirthdayCake = SolidIcon(0xf1fd)
    ...
    val BookReader = SolidIcon(0xf5da)
    ...
    val BorderStyle = SolidIcon(0xf853)
    ...
    val BroadcastTower = SolidIcon(0xf519)
    ...
    val ChalkboardTeacher = SolidIcon(0xf51c)
    ...
    val ClinicMedical = SolidIcon(0xf7f2)
    ...
    val CloudDownloadAlt = SolidIcon(0xf381)
    ...
    val CloudUploadAlt = SolidIcon(0xf382)
    ...
    val Diagnoses = SolidIcon(0xf470)
    ...
    // Solid icon : Dizzy
    val Dizzy = SolidIcon(0xf567)

    // https://fontawesome.com/icons/dizzy?style=regular
    // Regular icon : Dizzy
    val DizzyRegular = RegularIcon(0xf567)
    ...
    val DollarSign = SolidIcon(0xf155)
    ...
    val DollyFlatbed = SolidIcon(0xf474)

    // https://fontawesome.com/icons/donate?style=solid
    // Solid icon : Donate
    val Donate = SolidIcon(0xf4b9)
    ...
    val DraftingCompass = SolidIcon(0xf568)
    ...
    val DribbbleSquare = BrandIcon(0xf397)
    ...
    // Solid icon : Edit
    val Edit = SolidIcon(0xf044)

    // https://fontawesome.com/icons/edit?style=regular
    // Regular icon : Edit
    val EditRegular = RegularIcon(0xf044)
    ...
    val EnvelopeSquare = SolidIcon(0xf199)
    ...
    val FacebookSquare = BrandIcon(0xf082)
    ...
    val FeatherAlt = SolidIcon(0xf56b)
    ...
    val FileDownload = SolidIcon(0xf56d)
    ...
    val FileMedicalAlt = SolidIcon(0xf478)
    ...
    val FileUpload = SolidIcon(0xf574)
    ...
    val FootballBall = SolidIcon(0xf44e)
    ...
    val FunnelDollar = SolidIcon(0xf662)
    ...
    val GitSquare = BrandIcon(0xf1d2)
    ...
    val GithubSquare = BrandIcon(0xf092)
    ...
    val GooglePlusSquare = BrandIcon(0xf0d4)
    ...
    val GreaterThan = SolidIcon(0xf531)
    ...
    val HackerNewsSquare = BrandIcon(0xf3af)
    ...
    val Hamburger = SolidIcon(0xf805)
    ...
    val HandshakeAltSlash = SolidIcon(0xe05f)
    ...
    // Solid icon : HardHat
    val HardHat = SolidIcon(0xf807)

    // https://fontawesome.com/icons/hashtag?style=solid
    // Solid icon : Hashtag
    val Hashtag = SolidIcon(0xf292)
    ...
    // Solid icon : Hdd
    val Hdd = SolidIcon(0xf0a0)

    // https://fontawesome.com/icons/hdd?style=regular
    // Regular icon : Hdd
    val HddRegular = RegularIcon(0xf0a0)
    ...
    val HeadphonesAlt = SolidIcon(0xf58f)
    ...
    val IdCardAlt = SolidIcon(0xf47f)
    ...
    val InstagramSquare = BrandIcon(0xe055)
    ...
    val JournalWhills = SolidIcon(0xf66a)
    ...
    val LaptopHouse = SolidIcon(0xe066)
    ...
    // Brands icon : MediumM
    val MediumM = BrandIcon(0xf3c7)

    // https://fontawesome.com/icons/medkit?style=solid
    // Solid icon : Medkit
    val Medkit = SolidIcon(0xf0fa)
    ...
    val MoneyBillWaveAlt = SolidIcon(0xf53b)
    ...
    val MoneyCheckAlt = SolidIcon(0xf53d)
    ...
    val OdnoklassnikiSquare = BrandIcon(0xf264)
    ...
    val Pastafarianism = SolidIcon(0xf67b)
    ...
    val PeopleCarry = SolidIcon(0xf4ce)
    ...
    val PhotoVideo = SolidIcon(0xf87c)
    ...
    val PiedPiperSquare = BrandIcon(0xe01e)
    ...
    val PinterestSquare = BrandIcon(0xf0d3)
    ...
    // Solid icon : Poll
    val Poll = SolidIcon(0xf681)

    // https://fontawesome.com/icons/poll-h?style=solid
    // Solid icon : PollH
    val PollH = SolidIcon(0xf682)
    ...
    val PrescriptionBottleAlt = SolidIcon(0xf486)
    ...
    val Procedures = SolidIcon(0xf487)
    ...
    val ProjectDiagram = SolidIcon(0xf542)
    ...
    val RadiationAlt = SolidIcon(0xf7ba)
    ...
    val RedditSquare = BrandIcon(0xf1a2)
    ...
    // Solid icon : Redo
    val Redo = SolidIcon(0xf01e)

    // https://fontawesome.com/icons/redo-alt?style=solid
    // Solid icon : RedoAlt
    val RedoAlt = SolidIcon(0xf2f9)
    ...
    val RemoveFormat = SolidIcon(0xf87d)
    ...
    val RssSquare = SolidIcon(0xf143)
    ...
    // Solid icon : Save
    val Save = SolidIcon(0xf0c7)

    // https://fontawesome.com/icons/save?style=regular
    // Regular icon : Save
    val SaveRegular = RegularIcon(0xf0c7)
    ...
    val ShieldAlt = SolidIcon(0xf3ed)
    ...
    val ShippingFast = SolidIcon(0xf48b)
    ...
    val SlackHash = BrandIcon(0xf3ef)
    ...
    val SmokingBan = SolidIcon(0xf54d)

    // https://fontawesome.com/icons/sms?style=solid
    // Solid icon : Sms
    val Sms = SolidIcon(0xf7cd)
    ...
    val SpaceShuttle = SolidIcon(0xf197)
    ...
    val SquareRootAlt = SolidIcon(0xf698)
    ...
    val StarHalfAlt = SolidIcon(0xf5c0)
    ...
    val SteamSquare = BrandIcon(0xf1b7)
    ...
    // Solid icon : Sync
    val Sync = SolidIcon(0xf021)

    // https://fontawesome.com/icons/sync-alt?style=solid
    // Solid icon : SyncAlt
    val SyncAlt = SolidIcon(0xf2f1)
    ...
    val TachometerAlt = SolidIcon(0xf3fd)
    ...
    val TelegramPlane = BrandIcon(0xf3fe)
    ...
    val TheaterMasks = SolidIcon(0xf630)
    ...
    val TicketAlt = SolidIcon(0xf3ff)
    ...
    val Tripadvisor = BrandIcon(0xf262)
    ...
    val TruckLoading = SolidIcon(0xf4de)
    ...
    val TumblrSquare = BrandIcon(0xf174)
    ...
    val TwitterSquare = BrandIcon(0xf081)
    ...
    // Solid icon : Undo
    val Undo = SolidIcon(0xf0e2)

    // https://fontawesome.com/icons/undo-alt?style=solid
    // Solid icon : UndoAlt
    val UndoAlt = SolidIcon(0xf2ea)
    ...
    val University = SolidIcon(0xf19c)

    // https://fontawesome.com/icons/unlink?style=solid
    // Solid icon : Unlink
    val Unlink = SolidIcon(0xf127)
    ...
    val UnlockAlt = SolidIcon(0xf13e)
    ...
    val UserTimes = SolidIcon(0xf235)
    ...
    val UtensilSpoon = SolidIcon(0xf2e5)
    ...
    val ViadeoSquare = BrandIcon(0xf2aa)
    ...
    val VimeoSquare = BrandIcon(0xf194)
    ...
    // Solid icon : VolumeUp
    val VolumeUp = SolidIcon(0xf028)

    // https://fontawesome.com/icons/vote-yea?style=solid
    // Solid icon : VoteYea
    val VoteYea = SolidIcon(0xf772)
    ...
    val WhatsappSquare = BrandIcon(0xf40c)
    ...
    val WineGlassAlt = SolidIcon(0xf5ce)
    ...
    val XingSquare = BrandIcon(0xf169)
    ...
    val YoutubeSquare = BrandIcon(0xf431)
